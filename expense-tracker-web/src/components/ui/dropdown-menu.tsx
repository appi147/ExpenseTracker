...
function DropdownMenu(
  props: React.ComponentProps<typeof DropdownMenuPrimitiveRoot>
) {
  return <DropdownMenuPrimitiveRoot data-slot="dropdown-menu" {...props} />;
}

function DropdownMenuPortal(
  props: React.ComponentProps<typeof DropdownMenuPrimitivePortal>
) {
  return (
...
function DropdownMenuTrigger(
  props: React.ComponentProps<typeof DropdownMenuPrimitiveTrigger>
) {
  return (
...
function DropdownMenuGroup(
  props: React.ComponentProps<typeof DropdownMenuPrimitiveGroup>
) {
  return (
...
function DropdownMenuRadioGroup(
  props: React.ComponentProps<typeof DropdownMenuPrimitiveRadioGroup>
) {
  return (
...
function DropdownMenuSub(
  props: React.ComponentProps<typeof DropdownMenuPrimitiveSub>
) {
